# Historický handover — stav k 2026-09-12

Archiv zachovaný při vydání 0.6.0 (2026-09-15); obsah odpovídá vydání 0.5.0.
Aktuální stav má přednost v [hlavním handoveru](../../HANDOVER.md); níže jsou
i překonané údaje.
...
Předchozí souhrn je v [historickém archivu](2026-09-09.md);
...
- **Čerstvé ověření:** kompletní herní sada **762/762**, konvertor terénu **6/6**
  ...
  Podrobnosti a rozsah dalších kontrol: [ověření publikace](../release-verification-2026-09-12.md).
...
Autority: [ekonomika](../economy-expansion.md),
[jídlo](../food-and-military-supply.md), [den a noc](../day-night-analysis.md),
[mlha](../fog-of-war.md), [pauza a myšlenky](../unit-thoughts-and-pause.md),
[bydlení](../worker-housing.md).
...
Viz [V1 v běžné hře](../painted-terrain-game.md) a
[sandbox](../terrain-graphics-sandbox.md).
...
Autority: [stavba](../art/briefs/lumber-hut-construction-v1.md),
[zásoby](../art/briefs/lumber-hut-stock-v1-integration.md),
[půdorys v2](../art/briefs/lumber-hut-footprint-v2-integration.md).
...
[Herní integrační záznam](../art/briefs/lumberjack-pixellab-game-v1-integration.md)
a [skutečné herní QA](../art/qa/lumberjack-pixellab-game-v1/README.md)
...
Závazná jsou [AGENTS.md](../../AGENTS.md), [manuál budov v0.2](../art/building-style-guide.md)
a [společný postup objektů](../art/object-implementation-workflow.md).
...
[refaktorový audit](../refactor-audit-2026-09-11.md).
