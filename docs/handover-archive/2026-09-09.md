# Historický handover — stav k 2026-09-09

Archiv zachovaný při předání 2026-09-12. Aktuální stav má přednost v
[hlavním handoveru](../../HANDOVER.md); níže jsou i překonané údaje.


Stav k **2026-09-09**. Aktuální souhrn níže má přednost před zachovaným
...
## Aktuální ekonomika k 2026-09-09

- Godot **4.7.2**, vlastní procedurální 2,5D grafika, mřížka 48 × 48 px a
  autoritativní simulace na 10 Hz.
- **30 typů budov, 28 druhů zboží, 15 civilních profesí, 19 výrobních receptů a
...
- **Workers' Cottage** je vlastní obytné rozšíření za 3 prkna + 2 kameny.
  Každá dokončená a zapnutá chata ubytuje přesně dva nosiče nebo stavitele;
  sklad zůstává nouzovým ubytováním při nedostatku dosažitelných lůžek.
...
- Výchozí `setup_economy_demo()` má všech **30 typů v 35 dokončených budovách**
  na **259 obsazených polích**, dále pole/vinice, ložiska, pracovníky, startovní zásoby a
...
- **Save v20** uchovává ekonomiku, ložiska, terén, pobyt a nocleh jednotek,
  mlhu, dlouhodobou výživu a samostatné zapnutí lidí i budov. Obytné chaty
  nepřidávají nové save pole: využívají stávající `sleep_home_id` a při načtení
  se ověřuje vlastník, povolený typ obyvatele i kapacita dvou lůžek. Verze 1–19
  se dál migrují a neplatný vstup se odmítne bez změny rozehrané hry.
- Ověření na Godotu 4.7.2: **693/693 headless testů prošlo**. Rozpad sad a pokrytí:
...
ze skladu (1 kámen / 1 prkno) a hned vzniknou. Neexistuje strom odemykání ani
boj. Bydlení je zatím omezené na dvoulůžkové chaty pro nosiče a stavitele bez
domácí spotřeby. Věž má posádku a zásobu kamene,
...
- širší potřeby obyvatel a domácí spotřeba;
