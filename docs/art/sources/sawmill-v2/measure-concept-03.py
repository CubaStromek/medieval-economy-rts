...
SRC = ROOT / "docs/art/sources/sawmill-v2/concept-03-key.png"
QA = ROOT / "docs/art/qa/sawmill-v2"
RAW_SCALE = 0.1195
THRESHOLD = (400, 1030)
BOUNDS = (-60 / RAW_SCALE + 400, -80 / RAW_SCALE + 1030,
          100 / RAW_SCALE + 400, 1030)
DOOR = [(332, 645), (403, 628), (403, 913), (332, 931)]
CONTACTS = {
    "left masonry": (35, 841),
...
report = {
    ...
    "external_approach_raw_bounds": [400 - 20 / RAW_SCALE, 1030,
                                      400 + 20 / RAW_SCALE, 1030 + 40 / RAW_SCALE],
    ...
    "lower_image_south_margin_world_using_pixel_lower_edge": (1030 - box[3] - 1) * RAW_SCALE,
    ...
    "door_target_note": "Actual opening is taller than33world person but shorter than requested300raw. Native walking/open-door clearance remains to be verified.",
    "navigation_note": "Nav is23rawpx (~2.75world) south of the manually observed central lower step edge; final actual entry may need a small registration adjustment. Navigation is not registered at the painted door leaf.",
...
(QA / "concept-03-geometry.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n")
...
d.text((20, 20), "SAWMILL V2 / CONCEPT03 — measured source contacts, raw scale0.1195", fill="white", font=font)
d.rectangle((xy(BOUNDS[:2]), xy(BOUNDS[2:])), outline="#4ad8ff", width=3)
for x in (400 - 20 / RAW_SCALE, 400 + 20 / RAW_SCALE, 400 + 60 / RAW_SCALE):
    d.line((xy((x, BOUNDS[1])), xy((x, 1030))), fill="#377a91", width=1)
...
d.text((a+16,b+10), "nav (400,1030)", fill="white", font=font)
...
d.text((20, 1338), "Visible feet fit. South raster edge touches the boundary: native raised-platform/entry QA is still required.", fill="white", font=font)
...
canvas.save(QA / "concept-03-contact-guide.png")
