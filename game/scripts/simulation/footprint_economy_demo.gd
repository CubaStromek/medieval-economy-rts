...
const POSITIONS: Dictionary = {
	...
	"inn": Vector2i(1, 8), "lumber_hut": Vector2i(6, 8), "forester_hut": Vector2i(11, 8),
...
static func setup(world: Variant) -> void:
	...
	world._push_event("Full KaM footprints: every workshop has a clear southern doorway and connected roads.")
