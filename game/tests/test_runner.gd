...
const MountainousRegionStartTests = preload("res://tests/mountainous_region_start_tests.gd")
...
const FogOfWarTests = preload("res://tests/fog_of_war_tests.gd")
const FogSaveTests = preload("res://tests/fog_save_tests.gd")
const FogViewTests = preload("res://tests/fog_view_tests.gd")
const FogGameplayTests = preload("res://tests/fog_gameplay_tests.gd")
...
const PaintedTerrainTests = preload("res://tests/painted_terrain_tests.gd")
const PaintedTerrainDataTests = preload("res://tests/painted_terrain_data_tests.gd")
const PaintedTerrainSourceTests = preload("res://tests/painted_terrain_source_tests.gd")
...
const TransportSearchTests = preload("res://tests/transport_search_tests.gd")
const UnitSpriteTests = preload("res://tests/unit_sprite_tests.gd")
const LumberjackAnimationLibraryTests = preload("res://tests/lumberjack_animation_library_tests.gd")
const LumberjackPresentationTests = preload("res://tests/lumberjack_presentation_tests.gd")
const LumberjackViewTests = preload("res://tests/lumberjack_view_tests.gd")
...
const NutritionTests = preload("res://tests/nutrition_tests.gd")
const NutritionSaveTests = preload("res://tests/nutrition_save_tests.gd")
const NutritionUiTests = preload("res://tests/nutrition_ui_tests.gd")
const HungerUiTests = preload("res://tests/hunger_ui_tests.gd")
const ActivityControlTests = preload("res://tests/activity_control_tests.gd")
const PauseSaveTests = preload("res://tests/pause_save_tests.gd")
const UnitThoughtsTests = preload("res://tests/unit_thoughts_tests.gd")
const InspectorActivityTests = preload("res://tests/inspector_activity_tests.gd")
...
func _ready() -> void:
	...
	_record_suite("Mountainous Region start", MountainousRegionStartTests.TEST_COUNT, MountainousRegionStartTests.run())
	...
	_record_suite("Lumber hut footprint revision", LumberHutFootprintTests.TEST_COUNT, LumberHutFootprintTests.run())
	...
	_record_suite("Fog of war", FogOfWarTests.TEST_COUNT, FogOfWarTests.run())
	_record_suite("Fog saves", FogSaveTests.TEST_COUNT, FogSaveTests.run())
	_record_suite("Fog presentation and input", FogViewTests.TEST_COUNT, await FogViewTests.run(self))
	_record_suite("Fog gameplay activation", FogGameplayTests.TEST_COUNT, FogGameplayTests.run(self))
	...
	_record_suite("Gentle seven-day nutrition", NutritionTests.TEST_COUNT, NutritionTests.run())
	_record_suite("Seven-day nutrition saves", NutritionSaveTests.TEST_COUNT, NutritionSaveTests.run())
	_record_suite("Seven-day nutrition indicators", NutritionUiTests.TEST_COUNT, NutritionUiTests.run())
	_record_suite("Visible satiety", HungerUiTests.TEST_COUNT, HungerUiTests.run())
	_record_suite("Individual work and building pause", ActivityControlTests.TEST_COUNT, ActivityControlTests.run())
	_record_suite("Pause save compatibility", PauseSaveTests.TEST_COUNT, PauseSaveTests.run())
	_record_suite("Read-only first-person thoughts", UnitThoughtsTests.TEST_COUNT, UnitThoughtsTests.run())
	_record_suite("Activity inspector and controls", InspectorActivityTests.TEST_COUNT, await InspectorActivityTests.run(self))
	...
	_record_suite("Lumberjack animation assets and alpha", LumberjackAnimationLibraryTests.TEST_COUNT, LumberjackAnimationLibraryTests.run(self))
	_record_suite("Lumberjack observed animation state", LumberjackPresentationTests.TEST_COUNT, LumberjackPresentationTests.run(self))
	_record_suite("Lumberjack game presentation", LumberjackViewTests.TEST_COUNT, await LumberjackViewTests.run(self))
	...
	_record_suite("Painted V1 terrain", PaintedTerrainTests.TEST_COUNT, PaintedTerrainTests.run())
	_record_suite("Painted V1 material data", PaintedTerrainDataTests.TEST_COUNT, PaintedTerrainDataTests.run())
	_record_suite("Painted V1 source metadata", PaintedTerrainSourceTests.TEST_COUNT, PaintedTerrainSourceTests.run())
